...
export default function SuccessToast({ message }) {
    ...
    return createPortal(
        <div className="fixed bottom-6 right-6 z-9999 w-auto max-w-sm bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded shadow-lg animate-slide-in">
